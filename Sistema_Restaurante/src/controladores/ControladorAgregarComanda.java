...
/**
 * Servlet implementation class ControladorAgregarComanda
 */
@WebServlet("/ControladorAgregarComanda")
public class ControladorAgregarComanda extends HttpServlet {
	...
	private void procesarPeticion(HttpServletRequest request , HttpServletResponse
			...
			try {
				...
				request.getRequestDispatcher( "/vistaAgregarComanda.jsp" ).forward( request ,response );
